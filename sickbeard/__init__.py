...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_PORT, HTTPS_CERT, HTTPS_KEY, \
                ...
                QUALITY_DEFAULT, SEASON_FOLDERS_FORMAT, SEASON_FOLDERS_DEFAULT, SEASON_PACKS_DEFAULT, STATUS_DEFAULT, \
        ...
        SEASON_PACKS_DEFAULT = bool(check_setting_int(CFG, 'General', 'season_packs_default', 0))
...
def save_config():
    ...
    new_config['General']['season_packs_default'] = int(SEASON_PACKS_DEFAULT)
